(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@github/combobox-nav')) :
  typeof define === 'function' && define.amd ? define(['exports', '@github/combobox-nav'], factory) :
  (global = global || self, factory(global.TextExpanderElement = {}, global.comboboxNav));
}(this, (function (exports, comboboxNav) { 'use strict';
  ...
  class TextExpander {
    ...
    activate(match, menu) {
      ...
      comboboxNav.install(this.input, menu);
      menu.addEventListener('combobox-commit', this.oncommit);
      menu.addEventListener('mousedown', this.onmousedown); // Focus first menu item.

      comboboxNav.clearSelection(this.input, menu);
      comboboxNav.navigate(this.input, menu);
    }
    ...
    deactivate() {
      ...
      comboboxNav.uninstall(this.input, menu);
  ...
  exports.default = TextExpanderElement;
